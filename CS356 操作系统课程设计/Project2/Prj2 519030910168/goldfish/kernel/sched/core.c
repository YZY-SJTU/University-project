...
void scheduler_tick(void)
{
	...
	//output information of task
	if(curr->policy == SCHED_WRR)
	{
		printk("scheduler_tick: number:%d, pid: %d, wrr number  in the queue:%d\n",curr->policy, curr->pid, rq->wrr.nr_wrr_running);
...
recheck:
	...
	switch(p->policy)
	{
		case 0: printk("normal "); break;
		case 1: printk("fifo "); break;
		case 2: printk("rr "); break;
		case 3: printk("batch "); break;
		case 5: printk("idle "); break;
		case 6: printk("wrr "); break;
	}
	printk("pid: %d, proc: %s\n",p->pid,p->comm);
	return 0;
}
