...
public:
    ...
    vector<int> searchAllSubGraph(int NodeName);
    vector<int> searchAllSubGraph(int NodeName1, int NodeName2, double& weight);
...
private:
    ...
    void searchOneSubGraph(int NodeNum, string subGraphName, vector<int> &reachNode, vector<searchRoot> &nextSearch, int initialNode);
    double searchFromFirstToSecond(int NodeName1, int NodeName2, vector<int>& firstToSecond, vector<int>& result);
};
